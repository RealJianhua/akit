...
public class HighlightView {
	...
	private void init() {
		...
		mResizeDrawableWidth = resources
				.getDrawable(R.drawable.ic_cropphoto_buoy2);
		mResizeDrawableHeight = resources
				.getDrawable(R.drawable.ic_cropphoto_buoy);
	...
	protected void draw(Canvas canvas) {
		...
		if (!hasFocus()) {
			...
			if (mCircle) {
				...
				mOutlinePaint.setColor(0xFF0d8cc7);
			}
			try {
	...
	public void setup(Matrix m, Rect imageRect, RectF cropRect, boolean circle,
		...
		mNoFocusPaint.setARGB(0, 0, 0, 0);
		// mFocusPaint.setARGB(0, 0, 0, 0);
		// mNoFocusPaint.setARGB(0, 0, 0, 0);
